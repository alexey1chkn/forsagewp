...
final class WOOBE_FPROFILES extends WOOBE_EXT {
    ...
    public function woobe_ext_scripts() {
        ...
        <script>
            ...
            //lang.<?php echo $this->slug ?>.test = '<?php _e('test', 'woo-bulk-editor') ?>';
        </script>
        <?php
    }
    ...
    public function woobe_tools_panel_buttons() {
        ?>
        <a href="#" class="button button-secondary woobe_tools_panel_fprofile_btn" title="<?php _e('Filters profiles', 'woo-bulk-editor') ?>"></a>
        <?php
    }
