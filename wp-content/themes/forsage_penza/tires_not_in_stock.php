					...
					<li>
						<div class="characters">
							...
							<select name="shirina-shiny">
								<option selected> <?php echo $shirina_shiny != NULL ? $shirina_shiny : " - "; ?> </option>
					...
					<li>												
						<div class="characters">
							...
							<select name="profil-shiny">
								<option selected> <?php echo $profil_shiny != NULL ? $profil_shiny : " - "; ?> </option>
					...
					<li>
						<div class="characters">
							...
							<select name="posadochnyj-diametr">
								<option selected> <?php echo $posadochnyj_diametr != NULL ? $posadochnyj_diametr : " - "; ?> </option>
